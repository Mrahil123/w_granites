<header id="Header">
    <div class="main_header inner_page">
        <div class="top_nav" id="navbar">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo" >
                            <a href="index.html"  title="Crave Ordering"><img width="140px" src="images/global-one-logo.jpg" alt="global-one-logo"></a>
                        </div>
                        <div class="nav_manu">
                            <div class="Menu_list">
                                <ul class="menu">
        ...
        <div class="H_banner" id="ani">
            <div class="main_pitch">
                <div class="main_Order">
                    <h2 class="title">Head stones </h2>
                    <a class="btn-enquiry" href="contact-us.html">Send us an Enquiry</a>
                </div>
            </div>
        </div>
    </div>
    <div class="device">
        <nav class="main-nav" id="main-nav">
            <div class="logo">
                <a href="index.html" title="Crave Ordering"><img width="125px" src="images/global-one-logo.jpg" alt="Crave Ordering"></a>
            </div>
            <ul class="menu">
                <li><a href="{{route("home")}}" class="">Home</a></li>
