$(document).ready(function(){
    ...
    // Header Animating#
    var images = [
        "images/products/bg/Stone-Furniture-bg.png",
        "images/products/bg/granite-fence-poles-bg.png",
        "images/products/bg/head-stones-bg.png",
        "images/products/bg/wash-basins.png",
        "images/products/bg/Stone-laying-bg.png",
      ];
    var h1Texts = [
        "Stone Furniture",
        "Granite Fence Poles",
      ...
      var slideshowInterval = setInterval(changeBackgroundImage, 5000);
      ...
      function changeBackgroundImage() {
        ...
        $('#ani').fadeOut(500, function() {
          ...
          $(this).find('h2').text(h1Texts[currentIndex]).slideDown(200,"easeOutBounce");
